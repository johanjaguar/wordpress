...
?>
    ...
    <?php if ( have_comments() ) : ?>
        <h2 class="comments-title l-curiousblue">
            <?php
                printf( _n( 'Un comentario ', '%1$s comentarios ', get_comments_number(), 'shape' ),
        ...
        <nav role="navigation" id="comment-nav-above" class="site-navigation comment-navigation">
            <h1 class="assistive-text"><?php _e( 'Navegación de comentarios', 'shape' ); ?></h1>
            <div class="nav-previous"><?php previous_comments_link( __( '&larr; Comentarios antiguos', 'shape' ) ); ?></div>
            <div class="nav-next"><?php next_comments_link( __( 'Comentarios nuevos &rarr;', 'shape' ) ); ?></div>
    ...
    <?php endif; ?>
    <?php include("sections/blog/formcomment.php"); ?>
