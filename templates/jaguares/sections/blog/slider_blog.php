...
<div id="slider_box" class="montana">
    ...
    <?php endif?>
	<img src="<?php echo get_bloginfo('template_url'); ?>/assets/bxslider/images/blog.png" title="<a href='#'><h2><?php the_title(); ?></h2><br/><p class='l-dimgray'><?php the_date(); ?> / por <?php the_author(); ?> </p></a>"/></li>
    </ul>
</div>
